...
4. Abrir un Merge Request hacia `develop` con el identificador de Jira en el título.
5. Un integrante distinto revisa el Merge Request antes de integrarlo.

## Convenciones

- Commits: `feat(modulo): ...`, `fix(modulo): ...`, `docs: ...`, `test: ...`.
- No subir tokens, secretos de Cognito, contraseñas ni `local.properties`.
- Cada persona debe usar su propia cuenta de GitLab y autoría Git real.

## Reparto de trabajo sugerido

| Área | Responsable propuesto | Evidencia |
| --- | --- | --- |
| Backend, seguridad Cognito y base de datos | Juan Banda | Ramas `feature/backend-*`, pruebas Gradle, Merge Requests. |
| Android, UX y flujos por rol | Compañero/a | Ramas `feature/frontend-*`, capturas y Merge Requests. |
| Integración, documentación y demostración | Ambos | Revisión cruzada de MR, Jira actualizado y prueba integral. |
